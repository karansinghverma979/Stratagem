    ...
    {#if isConfirmed}
      <div class="notification-alert abort-alert" transition:fly={{ y: -50, x: 30, duration: 400 }}>
        ...
        <div class="notification-content">
          <span class="noti-title font-outfit">ARSENAL PURGED</span>
          <span class="noti-desc font-inter">Unrealized Stratagem Discharged</span>
        </div>
      </div>
    {/if}
      ...
      <div class="popup-container">
        ...
        {:else}
          <div class="comment-box-zone">
            <label class="comment-label font-mono">OPERATIONAL STATEMENT LOG</label>
            <div class="comment-input-wrapper">
              <textarea
                bind:value={comments}
                placeholder="PROVIDE CRITICAL REASONING FOR ARSENAL PURGE (REQUIRED)..."
        ...
        <div class="warning-zone">
          <div class="warning-header font-outfit">ARSENAL INTEL PURGE DETECTED</div>
          <p class="warning-text font-inter">
            PURGING COGNITIVE INTEL MID-WAY! COGNITIVE PROMISES UNRESOLVED. WARNING: THIS ARSENAL PURGE IS IRREVERSIBLE AND ALL RESEARCH PROGRESS WILL BE ERASED.
          </p>
        </div>
