    ...
    {#if isConfirmed}
      <div class="notification-alert abort-alert" transition:fly={{ y: -50, x: 30, duration: 400 }}>
        ...
        <div class="notification-content">
          <span class="noti-title font-outfit">PROTOCOL ABORTED</span>
          <span class="noti-desc font-inter">Emergency Purge Dispatched</span>
        </div>
      </div>
    {/if}
      ...
      <div class="popup-container">
        ...
        {:else}
          ...
          <div class="comment-box-zone">
            <label for="abort-comment-input" class="comment-label font-mono">OPERATIONAL STATEMENT LOG</label>
            <div class="comment-input-wrapper">
              <textarea
                id="abort-comment-input"
                bind:value={comments}
                placeholder="PROVIDE CRITICAL REASONING FOR DISPATCH TERMINATION (REQUIRED)..."
        ...
        <div class="warning-zone">
          <div class="warning-header font-outfit">PROTOCOL TERMINATION DETECTED</div>
          <p class="warning-text font-inter">
            ABANDONING PROTOCOL MID-WAY! COGNITIVE PROMISES BROKEN. WARNING: THIS TERMINATION IS IRREVERSIBLE AND PROGRESS WILL BE ERASED.
          </p>
        </div>
        ...
        <div class="actions-zone">
          ...
          >
            ...
            <span class="btn-text">CONFIRM PURGE</span>
          </button>
...
<style>
  ...
  /* Glassmorphism gradient flow container - Slightly more dark-themed for contrast */
  .confirm-modal {
    width: 90%;
    max-width: 560px;
    height: auto;
  ...
  .comment-textarea:focus {
    border-color: #ff2d55;
    box-shadow: 0 0 15px rgba(255, 45, 85, 0.45);
    background: rgba(28, 4, 12, 0.85);
  }
